...
export const HERO_REEL: CatalogPin[] = [
  ...
  pin({
    ...
    cut: "cut",
    camera: "handheld",
    alt: "Food vlog — beautiful host filming a kitchen cook",
    creditName: "Polina Tankilevitch",
    creditUrl: "https://www.pexels.com/video/woman-recording-herself-cooking-7690411/",
  }),
  pin({
    type: "video",
    videoId: 7670294,
    ...
    cut: "dissolve",
    camera: "cinematic",
    alt: "Home decor vlog — styling a bedroom with florals",
    creditName: "Ivan S",
    creditUrl: "https://www.pexels.com/video/woman-decorating-her-bedroom-7670294/",
  }),
  pin({
    type: "video",
    videoId: 24828231,
    ...
    cut: "whip",
    camera: "drift",
    alt: "Travel vlog — filming the city from the waterfront",
    creditName: "Ahmed",
    creditUrl: "https://www.pexels.com/video/a-woman-with-a-backpack-looking-at-the-city-24828231/",
  }),
  pin({
    type: "video",
    videoId: 12103937,
  ...
  pin({
    ...
    cut: "whip",
    camera: "kenburns",
    alt: "Aerial city — cinematic wanderlust still",
    creditName: "Pixabay",
  ...
  pin({
    ...
    cut: "whip",
    camera: "trailer",
    alt: "Neon night wash — viral energy still",
    creditName: "Pixabay",
    creditUrl: "https://www.pexels.com/photo/801863/",
  }),
  pin({
    type: "image",
    photoId: 1587927,
    ...
    cut: "push",
    camera: "cinematic",
    alt: "Crowd surge — go-viral campaign still",
    creditName: "Pedro Sandrini",
    creditUrl: "https://www.pexels.com/photo/1587927/",
  }),
  pin({
    type: "image",
    photoId: 1640777,
  ...
  pin({
    ...
    cut: "push",
    camera: "cinematic",
    alt: "Red lipstick and cosmetics — beauty product still",
    creditName: "Valeria Boltneva",
    creditUrl: "https://www.pexels.com/photo/2533266/",
  }),
  pin({
    type: "image",
    photoId: 1763075,
  ...
  pin({
    ...
    cut: "push",
    camera: "kenburns",
    alt: "Laptop workspace — product-grade tech still",
    creditName: "Pexels",
    creditUrl: "https://www.pexels.com/photo/1714208/",
  }),
  pin({
    type: "image",
    photoId: 546819,
    ...
    cut: "zoom",
    camera: "cinematic",
    alt: "Code on screen — developer tech still",
    creditName: "Pixabay",
    creditUrl: "https://www.pexels.com/photo/546819/",
  }),
  pin({
    type: "image",
    photoId: 3861969,
    ...
    cut: "whip",
    camera: "trailer",
    alt: "AI / neural still — futurist tech look",
