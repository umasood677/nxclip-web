...
export const HERO_REEL: CatalogPin[] = [
  pin({
    ...
    photoId: 1402787,
    niche: "gaming",
    alt: "Night race car — cinematic car-game campaign still",
    creditName: "JESHOOTS.com",
  ...
  pin({
    ...
    photoId: 112460,
    niche: "gaming",
    alt: "Sports-car motion — race-game trailer reel",
    creditName: "Pexels",
  ...
  pin({
    ...
    photoId: 4761663,
    niche: "gaming",
    alt: "Fight-night motion — fighting-game campaign reel",
    creditName: "Pexels",
    creditUrl: "https://www.pexels.com/video/4761790/",
  }),
  pin({
    type: "image",
    photoId: 2325717,
    niche: "gaming",
    alt: "Tactical night op — COD-level campaign still",
    creditName: "Pexels",
    creditUrl: "https://www.pexels.com/photo/2325717/",
  }),
  pin({
    type: "video",
    videoId: 8059279,
