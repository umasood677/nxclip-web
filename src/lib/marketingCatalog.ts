...
export const HERO_REEL: CatalogPin[] = [
  pin({
    ...
    photoId: 442576,
    niche: "gaming",
    alt: "Console session — controller in hand, match running on screen",
  ...
  pin({
    ...
    photoId: 1174746,
    niche: "gaming",
    alt: "Joystick session — player locked on the match",
    creditName: "Mikhail Nilov",
    creditUrl: "https://www.pexels.com/video/boyplaying-video-game-while-using-joystick-7986664/",
  }),
  pin({
    type: "video",
    videoId: 7986651,
    photoId: 275033,
    niche: "gaming",
    alt: "Couch co-op — wireless controller, game on",
    creditName: "Mikhail Nilov",
    creditUrl: "https://www.pexels.com/video/young-man-playing-a-video-game-7986651/",
  }),
  pin({
    type: "video",
    videoId: 9068460,
    photoId: 3945683,
    niche: "gaming",
    alt: "Two-player wireless session — controllers and live play",
    creditName: "Yan Krukau",
    creditUrl: "https://www.pexels.com/video/people-using-a-wireless-game-controller-in-playing-a-video-game-9068460/",
  }),
  pin({
    type: "video",
    videoId: 7855857,
    photoId: 7849519,
    niche: "gaming",
    alt: "Living-room session — controller in hand, game running",
    creditName: "Ron Lach",
    creditUrl: "https://www.pexels.com/video/a-man-playing-video-games-using-a-game-controller-7855857/",
  }),
  pin({
    type: "video",
    videoId: 9068508,
    photoId: 7862491,
    niche: "gaming",
    alt: "Hands on the pad — buttons, sticks, live gameplay",
    creditName: "Yan Krukau",
  ...
  pin({
    ...
    photoId: 7915437,
    niche: "gaming",
    alt: "Headset gamer at a lit monitor — in-session PC play",
    creditName: "Yan Krukau",
    creditUrl: "https://www.pexels.com/photo/7915437/",
  }),
  pin({
    type: "image",
    photoId: 7862483,
    niche: "gaming",
    alt: "DualSense in neon — console session still",
    creditName: "Yan Krukau",
    creditUrl: "https://www.pexels.com/photo/7862483/",
  }),
  pin({
    type: "image",
    photoId: 3165335,
    niche: "gaming",
    alt: "Headset, DualShock, and keyboard — gaming desk kit",
    creditName: "Pexels",
    creditUrl: "https://www.pexels.com/photo/3165335/",
  }),
  pin({
    type: "image",
    photoId: 2681751,
